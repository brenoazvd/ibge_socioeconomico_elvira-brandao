...
Uso:
  ...
  python preencher_endereco_por_latlon.py "arquivo.csv" [--saida out.csv] [--sleep 1.2] [--useragent "SeuApp/1.0 (email@dominio.com)"]
"""
...
def main():
    ...
    print(f"OK: CEPs preenchidos em {filled}/{total}. Arquivo salvo em: {out}")
